...
- ИСПРАВЛЕНО с 2026-07-12 (FIX_FIRST, первый круг конвейера): обрезка
  ...
  выборку домено-подобных символов (буква любого алфавита/цифра/дефис/
  точка). Три ревьюера нашли обход: обрамление домена символом ВНЕ
...
- ИЗВЕСТНО и НЕ ЧИНИТСЯ (AUTHOR_DECISION D-DET-3, 2026-07-12): сама
  ...
  теряется). Задокументировано в gate_bare_domain_detector.py, не
  считается дефектом — см. отдельный файл AUTHOR_DECISION в
  foundation_layer.
